...
Citizen.CreateThread(function()
  ...
  while true do
    ...
    elseif WarMenu.IsMenuOpened('objectsub') then
      ...
      if WarMenu.ComboBox('Object', objects, currentObjectIndex, selectedObjectIndex, function(currentIndex,
                                                                                               selectedIndex)
    ...
    elseif WarMenu.IsMenuOpened('speedzones') then
      ...
      elseif WarMenu.Button('Create Zone') then
        ...
        ESX.ShowNotification('Created Speed Zone.')
      ...
      elseif WarMenu.Button('Delete Zone') then
        ...
        ESX.ShowNotification('Disabled zones.')
      end
...
AddEventHandler('Zone', function(speed, radius, x, y, z)
  ...
  speedZone = AddRoadNodeSpeedZone(x, y, z, radius, speed, false)
...
AddEventHandler('RemoveBlip', function()
  ...
  RemoveRoadNodeSpeedZone(speedzones[closestSpeedZone][4])
